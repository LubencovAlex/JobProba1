...
import com.example.jobproba1.databinding.FragmentFavoriteBinding

class FavoriteFragment : Fragment(), AllVacancyCardDataAdapter.Listener {
    ...
    private fun updateFavoritesCards(){
        viewModelVacancy.favoriteVacancyCardData.observe(viewLifecycleOwner){ vac ->
            val vacancyAdapter = AllVacancyCardDataAdapter(this)
            binding.rcViewFavorites.adapter = vacancyAdapter
